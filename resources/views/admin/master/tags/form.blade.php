    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <h4 class="card-title">{{ $mode_page }} Tag</h4>
            <form class="forms-sample" method="POST" action="/tag">
              ...
              <div class="form-group row">
                <label for="tag" class="col-sm-3 col-form-label">Name</label>
                <div class="col-sm-7">
                  <input type="text" name="name" value="{{ isset($rs_id) ? $rs_id->name : '' }}" class="form-control" placeholder="input tag name" autocomplete="off">
                </div>
              </div>
